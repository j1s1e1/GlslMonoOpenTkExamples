...
{
	public class Tut_ShadowMap : TutorialBase
	{
		...
		{
			int vertex_shader = Shader.compileShader(ShaderType.VertexShader, VertexShaders.ShadowMap);
			int fragment_shader = Shader.compileShader(ShaderType.FragmentShader, FragmentShaders.ShadowMap);
