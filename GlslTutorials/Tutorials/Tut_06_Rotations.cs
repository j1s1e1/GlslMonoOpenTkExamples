...
namespace GlslTutorials
{
	public class Tut_06_Rotations : TutorialBase
	{
	    ...
	    {
	        int vertex_shader = Shader.compileShader(ShaderType.VertexShader, PosColorLocalTransform_vert);
	        int fragment_shader = Shader.compileShader(ShaderType.FragmentShader, ColorPassthrough_frag);
